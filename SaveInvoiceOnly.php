...
$htmlHeader='<img id="topbanner" src="images\pbprintbanner1.jpg"  border="0"><br> This Invoice has been saved: Invoice: '.$InvoiceNumber.'&nbsp &nbsp Date: '.date("d/m/Y", time()).'&nbsp &nbsp Employee: '.$Name.'<br>';
