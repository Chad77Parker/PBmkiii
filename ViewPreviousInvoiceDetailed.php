...
echo '<tr><td colspan="5" class="general"><input type="hidden" name="JobQuery" value="'.$queryjobs.'"><input type="hidden" value="'.$_SESSION['EmployeeInd'].'" name="EmployeeInd"><input type="hidden" name="InvoiceNumber" value="'.$_POST['Invoice'].'"><center><input type="submit" value="Print">';
echo '</table></form>';
?>
</div>
</body>
