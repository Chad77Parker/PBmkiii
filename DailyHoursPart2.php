...
<html>
<head>
<title>Daily Hours Part 2</title>';
echo MobileDetect();
?>
...
<tr><td class="general">Date<td colspan="1" class="general">
<?php
...
echo '<tr><td class="general">Start Time <td colspan="1" class="general"> ';
echo $_POST['StartTimehours'].':'.$_POST['StartTimeminutes'].'<input type="hidden" name="StartTime"value="'.$_POST['StartTimehours'].$_POST['StartTimeminutes'].'00">';

   
echo '<tr><td class="general"> Finish Time<td colspan="1" class="general">';
echo $_POST['EndTimehours'].':'.$_POST['EndTimeminutes'].'<input type="hidden" name="EndTime" value="'.$_POST['EndTimehours'].$_POST['EndTimeminutes'].'00">';

echo '<tr><td class="general">Lunch break <td colspan="1" class="general">';
echo $_POST['Lunchhours'].':'.$_POST['Lunchminutes'].'<input type="hidden" name="Lunch" value="'.$_POST['Lunchhours'].$_POST['Lunchminutes'].'00">';
...
echo '<tr><td colspan="4"><input type="submit" Value="Save Employee Hours and Continue" >';
