...
if ($_POST['ClientInd']=="All"){
	$queryjobs='select * from jobs where '.$status.'EndDate between '.
	$_POST['StartDateyear'].$_POST['StartDatemonth'].$_POST['StartDateday'].' and '.
	$_POST['EndDateyear'].$_POST['EndDatemonth'].$_POST['EndDateday'].' order by ClientInd, EndDate;';
}
else {
$queryjobs='select * from jobs where '.$status.'ClientInd='.$_POST['ClientInd'].' and EndDate between '.
	$_POST['StartDateyear'].$_POST['StartDatemonth'].$_POST['StartDateday'].' and '.
	$_POST['EndDateyear'].$_POST['EndDatemonth'].$_POST['EndDateday'].' order by ClientInd, EndDate;';
}
