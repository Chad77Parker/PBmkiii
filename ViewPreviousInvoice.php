...
$PrevClient=0;
echo 	'<br><form method="post" action="PrintInvoice.php"><table class="threequarterwidth" border="2">';
...
echo '<tr><td colspan="5" class="general"><input type="hidden" name="JobQuery" value="'.$queryjobs.'"><input type="hidden" name="EmployeeInd" value="'.$_SESSION['EmployeeInd'].'" ><input type="hidden" name="InvoiceNumber" value="'.$_POST['Invoice'].'"><center><input type="submit" value="Print">';
echo '</table></form>';
?>
</div>
</body>
